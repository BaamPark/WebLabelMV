...
def build_contextual_chat_prompt(project, image_relationship_text=None,
    ...
    action_instructions = (
        ...
        "When the user asks to classify or update attributes for the selected box, call update_box_attributes with "
        "{\"action\":\"update_box_attributes\",\"target_frame\":\"current\",\"box_id\":\"<selected box id>\",\"attributes\":\"auto\"}. "
        "For classifying only specific attributes, set attributes to an array of project attribute names, for example "
        "{\"action\":\"update_box_attributes\",\"target_frame\":\"current\",\"box_id\":\"<selected box id>\",\"attributes\":[\"Gown\",\"Mask\"]}. "
        "The backend will classify requested attributes and update the box. "
