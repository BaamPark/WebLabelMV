...
def build_contextual_chat_prompt(project, image_relationship_text=None,
    ...
    action_instructions = (
        "If the user asks you to create new annotation boxes from the frame, use create_box. "
        ...
        "Creation example: ACTION_JSON: {\"action\":\"create_box\",\"target_frame\":\"current\",\"boxes\":[{\"className\":\"clinician\",\"bbox_1000_yx\":[100,100,500,300]}]}. "
        ...
        "\"bbox_1000_yx\":[y1,x1,y2,x2]}]}. "
        "For create_box only, use Gemini-style bbox_1000_yx order [y1, x1, y2, x2], with integers normalized to [0,1000]. "
        ...
        "{\"action\":\"update_box_attributes\",\"target_frame\":\"current|target\",\"box_id\":\"<existing box id>\",\"attributes\":{\"<attribute name>\":\"<attribute code>\"}} "
        "or this multi-box schema: "
        "{\"action\":\"update_box_attributes\",\"target_frame\":\"current|target\",\"updates\":[{\"box_id\":\"<existing box id>\",\"attributes\":{\"<attribute name>\":\"<attribute code>\"}}]}. "
        "When the user asks to classify, update, or assign all attributes for the selected box, directly choose the attribute values and call update_box_attributes. "
        ...
        "Use bbox_1000_yx integers in [0,1000] for create_box and bbox_1000 integers in [0,1000] for geometry updates. "
        "Use target_frame=\"target\" only when a target frame is available. "
